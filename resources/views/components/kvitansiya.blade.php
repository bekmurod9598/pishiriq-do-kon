  ...
  <div id="invoice-POS">
    ...
    <center id="top">
      ...
      <div class="info"> 
		...
		<svg class="brand-title" width="150" height="40" viewBox="0 0 150 40" xmlns="http://www.w3.org/2000/svg">
          <!-- Matnni chizamiz, fill rangini blue qilib belgilaymiz -->
          <text x="0" y="30" font-family="Cambria Math" font-size="30" fill="SteelBlue" font-weight="bold" letter-spacing="4">YASIN</text>
        </svg>
    ...
    <div id="mid">
      <div class="info">
        ...
        <p> 
            Savdo raqam :       1421</br>
            Sana :              {{ date("d.m.Y H:i") }}</br>
            Mijoz :             Aliyev Vali</br>
        </p>
      </div>
    </div><!--End Invoice Mid-->
