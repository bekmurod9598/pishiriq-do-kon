<x-layouts.main>
    ...
    <div class="content-body">
        <div class="page-titles" style="justify-content:center !important">
            <ol class="breadcrumb">
                <li>
                    <h5 class="heading mb-0 text-primary text-center text-uppercase fw-bold">MAHSULOT TURLARI OYNASI
                    </h5>
                </li>
            </ol>
        </div>
                    ...
                    <div class="page-titles">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="btn btn-primary btn-sm ms-2" data-bs-toggle="modal" data-bs-target="#basicModal">
                                <i class="fa fa-plus-square"></i>  Tur qo'shish
                            </button>
                        </li>
                    </div>
                    <div class="card-body">
                                ...
                                <table class="table table-bordered table-responsive-sm text-center" style="font-size: 14px;">
                                    <thead>
                                        <tr >
                                            ...
                                            <th style="background-color: #87CEEB; color: white;">Tur nomi</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <!-- O'chirish tugmasi -->
                                                @if (date("Y-m-d")==date("Y-m-d", strtotime($type->created_at)))
                                                    ...
                                                    <x-modal modalId="deleteModal{{ $type->id }}" title="Modelni o'chirish" action="{{ route('types.update', $type->id ?? 0) }}" />
                                                @else
                                                    -
                                                @endif
                                            </td>
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="4">Hozircha hech qanday tur mavjud emas.</td>
                                        </tr>
                                    @endforelse
                                    </tbody>
                                </table>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Yangi tur qo'shish</h5>
                ...
                <div class="modal-body">
                    <form action="{{ route('types.store') }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-sm-12">
                                ...
                                <input type="text" class="form-control mb-xl-0 mb-3" name="type"value="{{ old('type') }}" placeholder="Paddon">
                            </div>
                            @error('type')
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-primary light m-r-5" title="Yangi turni saqlash" type="submit"><i class="fa-check fa-solid fa-check me-1"></i>Saqlash</button>
                    </div>
                </form>
            </div>
        </div>
